  ...
  return (
    ...
    >
      <section className="relative w-full pt-[130px] phone2:pt-[140px] phone3:pt-[160px] tablet1:pt-[164px] tablet2:pt-[177px] desktop1:pt-[195px] desktop2:pt-[235px] pb-[64px] desktop1:pb-[96px] flex items-center justify-center overflow-hidden font-mainFont">
        ...
        <SectionWrapper>
          <div className="relative z-10 grid items-center w-full gap-4 lg:grid-cols-2 phone2:gap-6 lg:gap-20">
            {/* Content */}
            ...
            >
              ...
              <h1
                className={` desktop1:text-start text-[26px] phone2:text-3xl md:text-4xl lg:text-5xl font-medium leading-[1.1] ${text} `}
              >
              ...
              /> */}
              {obs && (
                <div className="flex items-center justify-start w-full gap-3 text-sm text-mutedForeground">
